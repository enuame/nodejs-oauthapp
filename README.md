...
`<DISCLAIMER> - Please check the code before using, as I can't garuntee that there are no security loops or issues. There are also parts of the code missing, I will add these at a later date.`
